...
`timestamp,battery,node_id,<values…>` where the battery column is taken from an
analog reading on pin A0 wired directly to the battery (reported as 0 when below
about 0.5&nbsp;V).
